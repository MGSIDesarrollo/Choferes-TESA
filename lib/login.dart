import 'package:choferes/funciones/colores.dart';
...
class _LoginState extends State<Login> {
                            ...
                            child: ElevatedButton(
                              ...
                              onPressed: () {
                                if(_formKey.currentState!.validate()){
                                  print("Data: " +usrCtr!.text +' '+ pssCtr!.text);
                                  loginReq(usrCtr!.text, pssCtr!.text).then((onValue) async {
                                    if (onValue!=null) {
                                      ...
                                      Usuario usuario = Usuario(id: onValue.id, nombres: onValue.nombres.toString(), telefono: onValue.telefono.toString(), vehiculo: '0');
  ...
  Widget _session() => hasSession == 0 ? Center(child: loadingUser) : Text('');
