...
showAlertDialog(BuildContext context, String tittle, String message, {Icon icono = const Icon(Icons.warning, color: Colors.yellow, size: 55.0)}) {
...
Future<bool?> showAlertSelectDialog(BuildContext context, String title, {titleStyle: DARK_TEXT_STYLE, content: '', contentStyle: TEXT_MEDIUM}) async{
  AlertDialog alert = AlertDialog(
    title: Row(
        children: <Widget>[
    ...
    content: content != '' ? Text(content, style: contentStyle,) : null,
    actions: <Widget>[
      TextButton(
