...
Column(
  ...
  children: [
    ...
    Text('No tiene viajes por iniciar o finalizar.', style: TextStyle(color: DARK_BLUE_COLOR, fontFamily: 'PTSerif'),),
  ],),
);
...
Widget outConection = Center(child:
Column(
  mainAxisAlignment: MainAxisAlignment.center,
  children: [
    ColorFiltered(
      colorFilter: ColorFilter.mode(DARK_BLUE_COLOR, BlendMode.srcIn),
      child: Image.asset('assets/icons/wifi.png', width: 100,),
    ),
    Text('El historial solo esta disponible con conexión.', style: TextStyle(color: DARK_BLUE_COLOR, fontFamily: 'PTSerif'),),
  ],),
);
